...
const Register = (props) => {
  ...
  const register = (e) => {
    ...
    axios
      .post("https://unpopular-backend.herokuapp.com/register", {
        username: username,
        email: email,
        password: password,
      })
  ...
  return (
    <div>
                ...
                <Box className="loginRegisterContainer">
                  ...
                  <center>
                    <Button
                      ...
                      variant="text"
                    >
                      С регистрацията се съгласяватe с общите условия и
      ...
      >
        <ForgottenPassword toast={toast} setOpenPassword={setOpenPassword} />
      </PureModal>
    </div>
  );
};
